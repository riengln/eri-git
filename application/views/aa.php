...
<body>
    <div id=”wrapper”>
        <header>
            ...
            <nav>
                <ul>
                <li><a href=”<?php echobase_url().'index.php/web' ?>”>Home</a></li>
...
<section>
    ...
    <p align='justify'>Pada pengertian codeigniter di atas tadi di jelaskan bahwa codeigniter menggunakan metode MVC. Apa itu 45MVC? Kita juga harus mengetahui apa itu MVC sebelum masuk dan lebih jauh dalam belajar codeigniter.</p>
